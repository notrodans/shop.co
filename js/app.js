(() => {
    ...
    function rangeInit() {
        ...
        if (priceStart && priceEnd) priceSlider.noUiSlider.on("set.one", (function(valuesArray) {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new swiper_core_Swiper(".customers__slider", {
        ...
        const thumbs = new swiper_core_Swiper(".product-card__thumbnails", {
            mousewheel: {
                enabled: true
            },
            autoHeight: false,
        ...
        new swiper_core_Swiper(".product-card__main-image", {
